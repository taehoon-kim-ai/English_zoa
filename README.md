...
| 아바타 (Slack 사진 자동 + 업로드) | `avatar.go` | `topbar.jsx`/`main.jsx`/`profile.jsx`/`battle.jsx` 렌더 | (테이블 없음 — `users.avatar_url` 읽기/쓰기) |
| 배틀 초대 + 알림 | `battle.go` (invites) | `app.jsx` (NotificationCenter) | `battle_invites` |
